...
export const projects: ProjectSlides[] = [
    ...
    {
        id: '2',
        about: 'App to search movies (React, Redux, Express, MongoDB, TMDB API)',
    ...
    {
        id: '3',
        about: 'Social network app (React, Express, MongoDB)',
    ...
    },
    {
        ...
        browserUrl: 'https://olgatananova.github.io/portfolio/',
        gitHubUrl: 'https://github.com/OlgaTananova/portfolio',
